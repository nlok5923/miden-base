use super::{AccountError, AccountId, Digest, Assembler, AssemblyContext, AssemblyContextType, LibraryPath, Module, ModuleAst};
...
impl AccountCode {
    ...
    /// source code.
    pub fn new(module_ast: ModuleAst, account_id: AccountId, assembler: &mut Assembler) -> Result<Self, AccountError> {
